...
<template>
	<div class="relative min-h-screen flex items-center justify-center overflow-hidden p-4"
		...
		<!-- Card -->
		<div class="relative w-full max-w-[380px] animate-slide-up"
			...
			<div class="absolute top-0 left-8 right-8 h-px rounded-full"
				style="background: linear-gradient(90deg, transparent, rgba(99,102,241,0.8), transparent);" />

			<div class="p-8">
				<!-- Logo -->
				<div class="flex flex-col items-center">
					<img src="@/assets/logo-pos.png" alt="Laundry POS" class="h-36 w-auto mb-4 drop-shadow-lg" />
				</div>
				...
				<form @submit.prevent="submit" class="space-y-4">
					...
					<Transition name="shake">
						<div v-if="error" class="flex items-center gap-2 px-3 py-2.5 rounded-xl text-sm"
