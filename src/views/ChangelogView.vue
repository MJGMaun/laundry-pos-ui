    ...
    sections: [
      {
        ...
        items: [
          ...
          'Customers: admin and super_admin can now soft-delete a customer; order history is preserved; visiting a removed profile shows a "Customer Removed" screen',
          'Orders: status can be reverted one step backward by admin/super_admin via an "← Undo" button on Order Detail',
